function draw=earth(fig,X,X2,VAS,VAS2)
...
% image.
image_file = 'earth.jpg'%'http://upload.wikimedia.org/wikipedia/commons/thumb/c/cd/Land_ocean_ice_2048.jpg/1024px-Land_ocean_ice_2048.jpg';
...
plot3(0,0,0,'r*')
hold on
plot3(VAS(1),VAS(2),VAS(3),'r*')
hold on
plot3(VAS2(1),VAS2(2),VAS2(3),'g*')
hold on
...
axis equal;
% axis auto;
% xlim([-10000*1000,10000*1000])
% ylim([-10000*1000,10000*1000])
% Set initial view
view(0,30);
axis vis3d;
...
title('Distribution of the debris just after the collision')
end
